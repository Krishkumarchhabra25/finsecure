  ...
  return (
    <section className="relative flex flex-col items-center justify-center text-center min-h-screen mb-10 px-4 sm:px-6 md:px-12 lg:px-20 overflow-hidden bg-gradient-to-b from-black via-black to-[#1a150f]">
      ...
      >
        ...
        <button className="w-full md:w-auto px-6 py-3 rounded-full bg-gradient-to-br from-[#2d2f39] to-[#1e1f25] text-white text-sm font-semibold border border-[#555764] shadow-[inset_0_2px_4px_rgba(255,255,255,0.2)] hover:brightness-110 transition">
          Download Now
        </button>
      </motion.div>
      ...
      <div ref={statsRef} className="relative z-10 w-full px-4 mt-16 p-6 text-white flex flex-col items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[14px] sm:text-[16px] md:text-[20px] mt-2 text-white/80">
            Real impact. Real users. Real rewards.
          </p>

      <div className="mt-10 flex flex-row sm:flex-row md:gap-8 gap-6 w-full max-w-full mx-auto text-[#f3e4c7] justify-center items-center">
