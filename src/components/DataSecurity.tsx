...
export default function DataSecurity() {
  ...
  return (
    ...
    >
      ...
      {/* Top Title */}
      <h3
        className={`${playfairDisplay.className}  uppercase p-2 text-[24px] md:text-[35px] leading-[100%] md:tracking-[0.64px] max-w-full`}
      >
      ...
      {/* Main Text */}
      <p
        className="text-white font-normal text-[18px] md:text-[55px] leading-[100%] tracking-[0.64px] max-w-5xl  mt-7 md:mt-20"
